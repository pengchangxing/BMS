...
namespace Sales
{
    public partial class Form_orderscheck : Form
    {
        ...
        private void bind()
        {
            ...
            //查询所有信息
            sqlc.CommandText = "select a.场租单号 订单号,c.名称 预约场地,a.入场时间,a.离场时间,a.备注,b.姓名 预约会员,a.状态 审核状态,d.姓名 操作人 from 场租单 a left join 用户 b on a.用户号=b.用户号 left join 场地 c on a.场地号=c.场地号 left join 用户 d on a.操作人号码=d.用户号 where a.状态='未审核' order by a.入场时间 desc";
            sql.Open();//打开数据库
