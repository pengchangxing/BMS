    ...
    public partial class Form_pl : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (button1.Text != "更新")
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        //插入语句
                        sqlc1.CommandText = "insert into 教练 values('" + textBox4.Text + "','" + comboBox1.Text + "','" + textBox2.Text + "','" + textBox5.Text + "','" + dateTimePicker1.Value + "','" + dateTimePicker2.Value + "','" + comboBox3.Items[comboBox2.SelectedIndex] + "','" + textBox3.Text + "','" + textBox6.Text + "')";
                        sql1.Open();//打开数据库
            ...
            else
            {
                ...
                sqlc1.Connection = sql1;//将该查询对象的连接设置为上面的数据库连接类
                //插入语句
                sqlc1.CommandText = "update 教练 set 姓名='" + textBox4.Text + "',性别='" + comboBox1.Text+"',内容='" + textBox2.Text + "',联系方式='" + textBox5.Text + "',可预约开始时间='" + dateTimePicker1.Value + "',可预约结束时间='" + dateTimePicker2.Value + "',场地号='" + comboBox3.Items[comboBox2.SelectedIndex] + "',备注='" + textBox3.Text + "',时租='" + textBox6.Text + "' where 教练号='" + textBox4.Tag + "'";
                sql1.Open();//打开数据库
                int result = sqlc1.ExecuteNonQuery();//执行语句返回影响的行数
                if (result > 0)//如果执行成功则返回1
                {
